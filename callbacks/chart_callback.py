...
def update_comparativo(cand,):
    df_comparativo = local_data.comparativo(cand)
...
def update_output(value,):
    df_sum_legenda = local_data.ranking_partidos()
...
def update_map_output(value, tipo_mapa):
    pass
    # merged = ChartCallback.local_data.get_chart_map(
